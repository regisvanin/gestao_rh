...
class UtilizouHoraExtra(View):
    def post(self, *args, **kwargs): #pegou varios parametros no pk
...
class DesutilizarHoraExtra(View):
    def post(self, *args, **kwargs): #pegou varios parametros no pk
        registro_hora_extra = RegistroHoraExtra.objects.get(id=kwargs['pk'])
...
class ExportarParaCSV(View):
    def get(self, request):
        ...
        writer.writerow(['Id', 'Motivo', 'Funcionario', 'Restante', 'Horas']) # colunas separadas por ,

        for registro in registro_he:
            writer.writerow([registro.id, registro.motivo, registro.funcionario, registro.funcionario.total_horas_extra, registro.horas]) # dados das linhas
...
class ExportarExcel(View):
    def get(self, request):
        ...
        response['Content-Disposition'] = 'attachment; filename="rel_excel.xls"'
